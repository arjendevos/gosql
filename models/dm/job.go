...
var JobWhere = struct {
	...
	ID:        whereHelperint{field: "\"job\".\"id\""},
	Type:      whereHelperstring{field: "\"job\".\"type\""},
	CreatedAt: whereHelpertime_Time{field: "\"job\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"job\".\"updated_at\""},
}
...
func (r *jobR) GetInstagramAccounts() InstagramAccountSlice {
	if r == nil {
		return nil
	}
...
var (
	jobAllColumns            = []string{"id", "type", "created_at", "updated_at"}
	jobColumnsWithoutDefault = []string{"type"}
	jobColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
...
func (q jobQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Job, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dm: failed to execute a one query for job")
	}
...
func (q jobQuery) All(ctx context.Context, exec boil.ContextExecutor) (JobSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dm: failed to assign all query results to Job slice")
	}
...
func (q jobQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dm: failed to count job rows")
	}
...
func (q jobQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dm: failed to check if job exists")
	}
...
func (o *Job) InstagramAccounts(mods ...qm.QueryMod) instagramAccountQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instagram_account\".\"job_id\"=?", o.ID),
	)
...
func (jobL) LoadInstagramAccounts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeJob interface{}, mods queries.Applicator) error {
	var slice []*Job
	var object *Job
	...
	query := NewQuery(
		...
		qm.WhereIn(`instagram_account.job_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Job) AddInstagramAccounts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*InstagramAccount) error {
	var err error
...
// Sets o.R.Job's InstagramAccounts accordingly.
// Replaces o.R.InstagramAccounts with related.
// Sets related.R.Job's InstagramAccounts accordingly.
func (o *Job) SetInstagramAccounts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*InstagramAccount) error {
	query := "update \"instagram_account\" set \"job_id\" = null where \"job_id\" = $1"
...
// Sets related.R.Job.
func (o *Job) RemoveInstagramAccounts(ctx context.Context, exec boil.ContextExecutor, related ...*InstagramAccount) error {
	if len(related) == 0 {
		return nil
	}
...
func FindJob(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Job, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dm: unable to select from job")
	}
...
func (o *Job) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dm: no job provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dm: unable to insert into job")
	}
...
func (o *Job) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dm: unable to update job, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to update job row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dm: failed to get rows affected by update for job")
	}
...
func (q jobQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to update all for job")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to retrieve rows affected for job")
	}
...
func (o JobSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to update all in job slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to retrieve rows affected all in update all job")
	}
	return rowsAff, nil
}
...
func (o *Job) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dm: no job provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dm: unable to upsert job, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "dm: unable to upsert job")
	}
...
func (o *Job) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dm: no Job provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to delete from job")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dm: failed to get rows affected by delete for job")
	}
...
func (q jobQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dm: no jobQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to delete all from job")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dm: failed to get rows affected by deleteall for job")
	}
...
func (o JobSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dm: unable to delete all from job slice")
	}
...
func (o *JobSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dm: unable to reload all in JobSlice")
	}
...
func JobExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dm: unable to check if job exists")
	}
